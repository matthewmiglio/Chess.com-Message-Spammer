...
class GameSaver:
    ...
    def save_game(self, game: Game):
        ...
        try:
            ...
            self.logger.info(f"Saved game: {game.white_player} vs {game.black_player}")
        except Exception as e:
                ...
                try:
                    ...
                    for game in games:
                        ...
                        if scrape_limit and scrapes >= scrape_limit:
                            self.logger.info(f"Reached scrape limit of {scrape_limit} games")
                            return

                except Exception as e:
                    self.logger.log_scraping_error(username, e)
...
if __name__ == "__main__":
    saver = GameSaver()
    saver.scrape(scrape_limit=None)  
